...
import com.pentaho.qa.sdk.SDKPluginBaseTest;
...
//https://spiratest.pentaho.com/5/TestCase/11376.aspx
@SpiraTestCase( projectId = 5, testCaseId = 11376 )
public class DISchedulingTest extends SDKPluginBaseTest {

  protected static final Logger LOGGER = Logger.getLogger( DISchedulingTest.class );
  private final String SCHEDULER_API_CSV = "CSV_data/SchedulerAPI_DI/Scheduler_API_DI.csv";
  ...
  @SpiraTestSteps( testStepsId = "59477, 59478" )
  @CsvDataSourceParameters( dsUid = "Positive, Name, user, password", executeColumn = "TUID", executeValue = "P1",
      path = SCHEDULER_API_CSV, staticArgs = "SDK_job_file" )
  public void prerequsite( Map<String, String> args, String job_file ) {
    Repo repo = new Repo();
    repo.connect( "DI_Repo", adminUser );
  ...
  @SpiraTestSteps( testStepsId = "59489" )
  ...
  public void jobStateTest( Map<String, String> args ) {
    ...
    Schedule schedule = schedules.get( args.get( BaseObject.ARG_NAME ) );
  ...
  @Test( dataProvider = "DataProvider" )
  @SpiraTestSteps( testStepsId = "59479" )
  ...
  @Test( dataProvider = "DataProvider" )
  @SpiraTestSteps( testStepsId = "59480" )
  ...
  @SpiraTestSteps( testStepsId = "59481" )
  ...
  @Test( dataProvider = "DataProvider" )
  @SpiraTestSteps( testStepsId = "59482" )
  ...
  @Test( dataProvider = "DataProvider" )
  @SpiraTestSteps( testStepsId = "59483" )
  ...
  @Test( dataProvider = "DataProvider" )
  @SpiraTestSteps( testStepsId = "59484" )
  ...
  @Test( dataProvider = "DataProvider" )
  @SpiraTestSteps( testStepsId = "59485" )
  ...
  @Test( dataProvider = "DataProvider" )
  @SpiraTestSteps( testStepsId = "59486" )
  @CsvDataSourceParameters( dsUid = "TUID, user", executeColumn = "TestMethod", executeValue = "pause_start",
      path = SCHEDULER_API_CSV )
  ...
  @Test( dataProvider = "DataProvider" )
  @SpiraTestSteps( testStepsId = "59487" )
  ...
  @Test( dataProvider = "DataProvider" )
  @SpiraTestSteps( testStepsId = "59488" )
  ...
  @SpiraTestSteps( testStepsId = "59490" )
